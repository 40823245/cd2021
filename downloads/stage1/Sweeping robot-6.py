...
if clientID != -1:
    ...
    ret4, robotHandle = vrep.simxGetObjectHandle(clientID, "Sweeping robot-6", opmode)
    ...
    if ret1 == 0 and ret2 == 0 and ret3 == 0:
        ...
        for i in range(0, 3):
            ...
            print("Sweeping robot-6 position: (x = " + str(robotPos[0]) +\
                  ", y = " + str(robotPos[1]) + ")")
            ...
            print("Sweeping robot-6 orientation: (x = " + str(robotOrient[0]) + \
                  ", y = " + str(robotOrient[1]) +\
                  ", z = " + str(robotOrient[2]) + ")")
